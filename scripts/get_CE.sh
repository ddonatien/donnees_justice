...
#
# Notes:
#   CE_202401/ORCE_490229_20240112.xml requires fixing
#   CE_202412/DCE_495565_20241218.xml is empty
#
# Defaults:
#   START_MONTH = 1
#   END_MONTH   = 12
...
for (( year=START_YEAR; year<=END_YEAR; year++ )); do
  ...
  for (( month=month_start; month<=month_end; month++ )); do
    ...
    wget -nc "https://opendata.justice-administrative.fr/DCE/$year/$month_padded/CE_$year$month_padded.zip" -O "data/raw/CE_$year$month_padded.zip"
    unzip -o "data/raw/CE_$year$month_padded.zip" -d "data/raw/CE_$year$month_padded"
    rm "data/raw/CE_$year$month_padded.zip"
    # Your logic here
  done
